...
const Login = (props) => {
    ...
    const handleSubmit = async (evt) => {
        ...
        const resultData = await fetch("http://localhost:8000/login", {
            method: "post",
                            ...
                            <form onSubmit={handleSubmit}>
                                <div className="card border-0 px-4 py-5" style={{ margin: '45px 40px'}}>
                                    <div className="row mb-4 px-3">
                                        <h4 className="mb-0 mr-4 mt-2">Sign in with</h4>
                                    ...
                                    <div className="row px-3"> 
                                        ...
                                        <input className="mb-4" type="text" name="email" placeholder="Enter a valid email address" onChange={e => setEmail(e.target.value)} /> 
                                    </div>
                                    <div className="row px-3 mb-4"> 
                                        <label className="mb-1">
